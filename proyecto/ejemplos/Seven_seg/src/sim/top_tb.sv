...
module top_tb;
    ...
    */
    ...
    function automatic [6:0] expected (input [3:0] val);
        case (val)
            4'd0: expected = 7'b0111111;
            4'd1: expected = 7'b0000110;
            4'd2: expected = 7'b1011011;
            4'd3: expected = 7'b1001111;
            4'd4: expected = 7'b1100110;
            4'd5: expected = 7'b1101101;
            4'd6: expected = 7'b1111101;
            4'd7: expected = 7'b0000111;
            4'd8: expected = 7'b1111111;
            4'd9: expected = 7'b1100111;
            4'd10: expected = 7'b1110111;
            4'd11: expected = 7'b1111100;
            4'd12: expected = 7'b0111001;
            4'd13: expected = 7'b1011110;
            4'd14: expected = 7'b1111001;
            // 15
            default: expected = 7'b1110001;
        endcase
    endfunction
